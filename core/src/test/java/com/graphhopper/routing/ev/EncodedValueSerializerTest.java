...
class EncodedValueSerializerTest {
    ...
    void explicitString() {
        ...
        assertEquals("{\"className\":\"com.graphhopper.routing.ev.IntEncodedValueImpl\",\"name\":\"lanes\",\"bits\":3," +
                "\"min_value\":0,\"max_storable_value\":7,\"max_value\":0,\"negate_reverse_direction\":false,\"store_two_directions\":false," +
        ...
        assertEquals("{\"className\":\"com.graphhopper.routing.ev.DecimalEncodedValueImpl\",\"name\":\"max_width\",\"bits\":7," +
                "\"min_value\":0,\"max_value\":0,\"max_storable_value\":127,\"negate_reverse_direction\":false,\"store_two_directions\":false," +
